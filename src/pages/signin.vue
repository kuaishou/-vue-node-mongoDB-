<template>
  <div id="sign_wrap">
    <div v-if="status==1" class="main signIn">
      ...
      <el-button @click="signIn" class="sign" >登陆</el-button>
      <p class="toSignUp">没有账户的宝宝点击<span @click="toSignUp" >注册!</span></p>
    </div>
